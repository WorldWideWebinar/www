...
ALTER TABLE meeting_stt DROP FOREIGN KEY meeting_stt_ibfk_1;
ALTER TABLE user_meeting DROP FOREIGN KEY user_meeting_ibfk_2;

ALTER TABLE meeting_stt
    ADD CONSTRAINT meeting_stt_ibfk_1
        FOREIGN KEY (meeting_id) REFERENCES meeting(meeting_id)
            ON DELETE CASCADE;

ALTER TABLE user_meeting
    ADD CONSTRAINT user_meeting_ibfk_2
        FOREIGN KEY (meeting_id) REFERENCES meeting(meeting_id)
            ON DELETE CASCADE;
